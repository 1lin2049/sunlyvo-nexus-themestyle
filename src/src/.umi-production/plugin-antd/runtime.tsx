...
import merge from '/opt/1panel/www/sites/sunlyvo.com/index/wp-content/themes/sunlyvo-nexus/src/node_modules/.pnpm/lodash@4.18.1/node_modules/lodash/merge'
...
const getAntdConfig = () => {
  if(!cacheAntdConfig){
    cacheAntdConfig = getPluginManager().applyPlugins({
      ...
      initialValue: {
        ...{"theme":{"token":{"colorPrimary":"#0066ff","borderRadius":8,"fontSize":14}}},
      },
    });
