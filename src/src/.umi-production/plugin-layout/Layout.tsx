...
/// <reference types="/opt/1panel/www/sites/sunlyvo.com/index/wp-content/themes/sunlyvo-nexus/src/node_modules/@ant-design/pro-components" />
...
import {
  ProLayout,
} from "/opt/1panel/www/sites/sunlyvo.com/index/wp-content/themes/sunlyvo-nexus/src/node_modules/@ant-design/pro-components";
import './Layout.css';
...
const { formatMessage } = useIntl();
  ...
  return (
    <ProLayout
      route={route}
      location={location}
      title={userConfig.title || 'sunlyvo-nexus-admin'}
      navTheme="dark"
      siderWidth={256}
      onMenuHeaderClick={(e) => {
        e.stopPropagation();
